...
from ..api.data.resource.url import URL, SpiderURL
...
class AbstractScope (object):
    ...
    @property
    def targets(self):
        return self.addresses + self.domains + self.roots + self.web_pages + self.target_url
        ...
        if dns_resolution:
            ...
            for domain in domains_to_resolve:
                try:
                    ...
                    msg = "Cannot resolve domain name: %s" % domain
                    Logger.log_error("GoLismero:%s" % msg)
                    #warn(msg, RuntimeWarning)
